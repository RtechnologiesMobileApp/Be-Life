...
class ChatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      onTap: () async {
        debugPrint(
          "🔵 CHAT_DEBUG [UI]: ChatCard tapped for chatId: $id, name: $name",
        );
        Navigator.pushNamed(
          context,
        ...
        debugPrint(
          "🔵 CHAT_DEBUG [UI]: About to call fetchMessages for chatId: $id",
        );
        await context.read<ChatViewModel>().fetchMessages(id);
        debugPrint(
          "🔵 CHAT_DEBUG [UI]: fetchMessages completed for chatId: $id",
        );
      },
      minTileHeight: 0,
      ...
      trailing: Row(
        ...
        children: [
          Icon(
            Icons.circle,
            size: 6.h,
            color: unreadCount == 0 ? Colors.white : Colors.red,
          ),
          SizedBox(width: 7.w),
