...
class _SendMessageWidgetState extends State<SendMessageWidget> {
  ...
  void _onTextChanged(String text) {
    ...
    if (text.isNotEmpty && !_isTyping) {
      _isTyping = true;
      chatVM.startTyping(widget.receiverId);
    }
    ...
    _typingTimer = Timer(const Duration(seconds: 2), () {
      if (_isTyping) {
        _isTyping = false;
        chatVM.stopTyping(widget.receiverId);
      }
    });
  }
          ...
          children: [
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 16.sp,
                        color: Color(0xFF131313).withValues(alpha: 0.24),
                      ),
            ...
            InkWell(
              onTap: () async {
                ...
                chatVM.sendMessage(widget.receiverId);
              },
