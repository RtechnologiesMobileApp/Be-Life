    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          ,child: CachedNetworkImage(imageUrl: widget.img,height: 42.h,width: 42.h,fit: BoxFit.cover,)),
          title: Text(widget.name,style: Theme.of(context).textTheme.headlineMedium!.copyWith(fontSize: 18.sp,color: Colors.black),),
        ),
        actions: [
        ...
        builder: (context,cVM,_) {
          return Background(child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
               Expanded(child: MsgsWidget(currentChatId: widget.otherUserid,)),
