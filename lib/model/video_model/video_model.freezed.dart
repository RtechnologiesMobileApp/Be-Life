...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,postedBy,uploaderProfilePicture,uploaderName,likesCount,SavedCount,shareCount,commentsCount,viewsCount,isLiked,isSaved,DownloadAllow,videoUrl,thumbnailUrl,videoGenre,ShareLink,locationTag,duration,originalAudioOwnerId,videoResolution,videoRatio,PrivacyType,place,isOriginalSound,ageRestricted,videoCaption]);

@override
String toString() {
  return 'VideoModel(id: $id, postedBy: $postedBy, uploaderProfilePicture: $uploaderProfilePicture, uploaderName: $uploaderName, likesCount: $likesCount, SavedCount: $SavedCount, shareCount: $shareCount, commentsCount: $commentsCount, viewsCount: $viewsCount, isLiked: $isLiked, isSaved: $isSaved, DownloadAllow: $DownloadAllow, videoUrl: $videoUrl, thumbnailUrl: $thumbnailUrl, videoGenre: $videoGenre, ShareLink: $ShareLink, locationTag: $locationTag, duration: $duration, originalAudioOwnerId: $originalAudioOwnerId, videoResolution: $videoResolution, videoRatio: $videoRatio, PrivacyType: $PrivacyType, place: $place, isOriginalSound: $isOriginalSound, ageRestricted: $ageRestricted, videoCaption: $videoCaption)';
}
...
@override@JsonKey(includeIfNull: false) final  String? place;
//
